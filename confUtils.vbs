...
'Exit Function
    ...
    InfoBaseName = ResDict.Item(LCase("InfoBaseName")) ' "User_01" 'Имя ИБ
    ...
    RepositoryPath = ResDict.Item(LCase("RepositoryPath")) ' "E:\Repository\test" ' путь к хранилищу
		...
		' ВАЖНО - база должна быть ранее зарегистрирована как server:port\baseName - например, WorkServer:1541\User_01
